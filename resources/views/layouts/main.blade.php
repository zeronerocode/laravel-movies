        ...
        <div class="container mx-auto  flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('movies.popular') }}" class="hover:text-gray-300">Popular</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('movies.nowplaying') }}" class="hover:text-gray-300">Now Playing</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('movies.toprated') }}" class="hover:text-gray-300">Top Rated</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('movies.upcoming') }}" class="hover:text-gray-300">Up Coming</a>
                </li>
            </ul>
